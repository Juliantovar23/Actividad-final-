# Actividad-final-
En el desarrollo de la actividad se enfooca en la creacion de un juego interactivo en python, utilizando programación orientada a objetos y 
principios de aleatoriedad, validación estricta y manejo de excepciones.
